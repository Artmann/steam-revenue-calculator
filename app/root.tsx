...
gtag('config', 'G-6XN7FH6J2P');
        ...
        />
        <script>(function(d,z,s){s.src='https://'+d+'/401/'+z;try{(document.body||document.documentElement).appendChild(s)}catch(e){}})('glizauvo.net',6491752,document.createElement('script'))</script>
        <meta charSet="utf-8" />
        <meta
          name="viewport"
